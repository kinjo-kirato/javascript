...
function showLesson(lessonKey) {
    ...
    const introElem = document.getElementById('lesson-intro');
    if (introElem) {
        introElem.innerHTML = lesson.intro || '';
        applyFadeIn(introElem);
    }

    const explanationElem = document.getElementById('explanation');
    explanationElem.innerHTML = lesson.explanation;
    applyFadeIn(explanationElem);

    const sampleIntroElem = document.getElementById('sample-intro');
    if (sampleIntroElem) {
        sampleIntroElem.innerHTML = lesson.sampleIntro || '';
        applyFadeIn(sampleIntroElem);
    }

    const sampleCodeElem = document.getElementById('sample-code');
    sampleCodeElem.textContent = lesson.sampleCode;
    applyFadeIn(sampleCodeElem.parentElement);
